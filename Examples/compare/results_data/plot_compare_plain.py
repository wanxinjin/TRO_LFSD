...
# plot the true plain ipopt
if True:
    load1 = np.load('./plain_opt/compare_plain_ipopt_1.npy', allow_pickle=True).item()
    ...
    load2 = np.load('plain_opt/compare_plain_ipopt_2.npy', allow_pickle=True).item()
    ...
    load3 = np.load('plain_opt/compare_plain_ipopt_3.npy', allow_pickle=True).item()
...
if True:
    load1 = np.load('plain_opt/compare_bilevel_1.npy', allow_pickle=True).item()
    loss_trace1 = load1['loss_trace']
    waypoints = load1['waypoints']
    time_tau = load1['time_tau']
    parameter_trace1 = np.array(load1['parameter_trace'])
    ...
    load2 = np.load('plain_opt/compare_bilevel_2.npy', allow_pickle=True).item()
    loss_trace2 = load2['loss_trace']
    parameter_trace2 = np.array(load2['parameter_trace'])
    parameter_error2 = np.linalg.norm(parameter_trace2 - true_parameter, axis=1) ** 2
    opt_sol2 = load2['opt_sol']

    load3 = np.load('plain_opt/compare_bilevel_3.npy', allow_pickle=True).item()
    loss_trace3 = load3['loss_trace']
    parameter_trace3 = np.array(load3['parameter_trace'])
