...
load = np.load('quadrotor_case3.npy', allow_pickle=True).item()
...
# ax.plot(position[7:, 0], position[7:, 1], position[7:, 2], zorder=100, color='blue')
ax.plot(position[:50, 0], position[:50, 1], position[:50, 2], zorder=-100, color='blue',linewidth=2,)
ax.plot(position[50:, 0], position[50:, 1], position[50:, 2], zorder=100, color='blue',linewidth=2,)
...
seg1,seg2,seg3,seg4=24,27,133,132
