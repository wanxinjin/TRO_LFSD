...
waypoints=None
for trial in trials:
    load = np.load('./case_2/quadrotor_trial_'+str(trial)+'.npy', allow_pickle=True).item()
...
# ax.plot(position[7:, 0], position[7:, 1], position[7:, 2], zorder=100, color='blue')
ax.plot(position[:, 0], position[:, 1], position[:, 2], zorder=10000, color='blue',linewidth=2)
...
seg1,seg2,seg3,seg4=34,40,133,132
