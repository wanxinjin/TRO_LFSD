...
subcase1_learned_param_mean = np.mean(np.array(subcase2_learned_param_list), axis=0)
subcase1_learned_param_std = np.std(np.array(subcase2_learned_param_list), axis=0)
