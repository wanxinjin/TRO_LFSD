...
if True:
    ...
    env.initCost_Polynomial(w_thrust=0.1, goal_r_I=np.array([-8, 8, 2]))
    ...
    # seg1,seg2,seg3,seg4=25,29,134,146
    # ax.plot(position[:seg1, 0], position[:seg1, 1], position[:seg1, 2], zorder=10, color='blue')
    # ax.plot(position[seg2:seg3, 0], position[seg2:seg3, 1], position[seg2:seg3, 2], zorder=10, color='blue')
    # ax.plot(position[seg4:, 0], position[seg4:, 1], position[seg4:, 2], zorder=10, color='blue')
    ax.plot(position[:, 0], position[:, 1], position[:, 2], zorder=-100, color='blue',linewidth=2,)
    ...
    seg1,seg2,seg3,seg4=24,26,80,80
