...
if True:
    ...
    seg1,seg2,seg3,seg4=38,37,138,147
    ...
    seg1,seg2,seg3,seg4=38,37,138,146
    ...
    ax.plot(position[seg4:, 0], position[seg4:, 1], position[seg4:, 2], zorder=10, color='green',linewidth=3,label='unconstrained weights')
    # ax.plot(position[:, 0], position[:, 1], position[:, 2], zorder=100, color='blue')
    ax.plot(position2[:, 0], position2[:, 1], position2[:, 2], zorder=10, color='tab:orange',linewidth=3,label='constrained weights')
