...
path_features = weight_1 * feature_1 + weight_2 * feature_2 + weight_3 *0* feature_3 + weight_4 *0*feature_4 + 0.1 * feature_5
...
bar22 = ax.bar3d([gate1_bar1[0]], [gate1_bar1[1]], [1], dx=[0.5], dy=gate1_bar2[1]-gate1_bar1[1], dz=[0.5], color='#D95319')
bar23 = ax.bar3d([gate1_bar2[0]], [gate1_bar2[1]], [1], dx=[0.5], dy=[0.5], dz=[4.], color='#D95319', zorder=-100)
bar24 = ax.bar3d([gate1_bar1[0]], [gate1_bar1[1]], [4.5], dx=[0.5], dy=gate1_bar2[1]-gate1_bar1[1], dz=[0.5], color='#D95319', zorder=-100)

bar1 = ax.bar3d([gate2_bar1[0]], [gate2_bar1[1]], [3.5], dx=[0.5], dy=[0.5], dz=[3], color='#D95319')
bar11 = ax.bar3d([gate2_bar1[0]], [gate2_bar1[1]], [3.5], dx=[0.5], dy=gate2_bar2[1]-gate2_bar1[1], dz=[0.5], color='#D95319')
bar12 = ax.bar3d([gate2_bar1[0]], [gate2_bar1[1]], [6.5], dx=[0.5], dy=gate2_bar2[1]-gate2_bar1[1], dz=[0.5], color='#D95319')
