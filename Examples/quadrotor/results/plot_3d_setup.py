...
load = np.load('./case_1/quadrotor_trial_0.npy', allow_pickle=True).item()
param_init=load['parameter_trace'][0]
...
_, opt_sol = oc.cocSolver(ini_state, T, param_init)
...
bar1 = ax.bar3d([0.5], [0], [3.5], dx=[0.5], dy=[0.5], dz=[3], color='#D95319', zorder=-100)
bar11 = ax.bar3d([0.5], [0], [3.5], dx=[0.5], dy=[4.5], dz=[0.5], color='#D95319', zorder=-100)
bar12 = ax.bar3d([0.5], [0], [6.5], dx=[0.5], dy=[4.5], dz=[0.5], color='#D95319', zorder=-100)
bar13 = ax.bar3d([0.5], [4], [7.0], dx=[0.5], dy=[0.5], dz=[-3.5], color='#D95319', zorder=-100)
...
seg1,seg2,seg3,seg4=50,57,133,132
