...
if True:
    ...
    print('the final total distance to the waypoints is (for green): ', loss_trace[-1])
    ...
    print('the final total distance to the waypoints is (for orange): ', loss_trace2[-1])
    ...
    ax.plot(loss_trace, lw=5,  color='tab:green', label=r'(41) with $p\in R^4$')
