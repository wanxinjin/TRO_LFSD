...
if True:
    ...
    seg1,seg2,seg3,seg4=36,39,135,148
    ...
    seg1,seg2,seg3,seg4=20,29,136,142
    ax.plot(position[:seg1, 0], position[:seg1, 1], position[:seg1, 2], zorder=1000, color='blue',linewidth=3,)
    ...
    # ax.plot(position[:, 0], position[:, 1], position[:, 2], zorder=100, color='blue')
    imitation_seg1, imitation_seg2=67, 70
    ax.plot(imitation_position[0:imitation_seg1, 0], imitation_position[:imitation_seg1, 1], imitation_position[:imitation_seg1, 2], zorder=-100, color='c',linewidth=3,)
