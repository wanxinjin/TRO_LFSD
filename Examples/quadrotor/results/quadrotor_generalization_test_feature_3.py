...
if True:
    ...
    _, opt_sol2 = oc.cocSolver(ini_state, T, parameter_trace2[-1])
    ...
    ax.plot(position[:, 0], position[:, 1], position[:, 2], zorder=-100, color='green',linewidth=2,)
    ...
    seg1,seg2,seg3,seg4=38,37,131,139
    ax.plot(position[:seg1, 0], position[:seg1, 1], position[:seg1, 2], zorder=10, color='green',linewidth=2,)
    ax.plot(position[seg2:seg3, 0], position[seg2:seg3, 1], position[seg2:seg3, 2], zorder=10, color='green',linewidth=2,)
    ax.plot(position[seg4:, 0], position[seg4:, 1], position[seg4:, 2], zorder=10, color='green',linewidth=2,)
    ax.plot(position2[:, 0], position2[:, 1], position2[:, 2], zorder=-10, color='tab:orange',linewidth=2,)
    ...
    seg1,seg2,seg3,seg4=38,37,131,139
    ax.plot(position[:seg1, 0], position[:seg1, 1], position[:seg1, 2], zorder=10, color='green',linewidth=3,)
    ax.plot(position[seg2:seg3, 0], position[seg2:seg3, 1], position[seg2:seg3, 2], zorder=10, color='green',linewidth=3,)
    ax.plot(position[seg4:, 0], position[seg4:, 1], position[seg4:, 2], zorder=10, color='green',linewidth=3,)
    # ax.plot(position[:, 0], position[:, 1], position[:, 2], zorder=100, color='blue')
    seg1, seg2, seg3, seg4 = -1, 73, 91, 95
    ax.plot(position2[:seg1, 0], position2[:seg1, 1], position2[:seg1, 2], zorder=-10, color='tab:orange',linewidth=3,)
    # ax.plot(position2[seg2:seg3, 0], position2[seg2:seg3, 1], position2[seg2:seg3, 2], zorder=10, color='tab:orange',linewidth=3,)
    # ax.plot(position2[seg4:, 0], position2[seg4:, 1], position2[seg4:, 2], zorder=-10, color='tab:orange',linewidth=3,)
