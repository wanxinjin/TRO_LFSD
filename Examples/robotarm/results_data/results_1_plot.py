...
for k in num_trial:
    load = np.load('./results_1/num_waypoints_' + str(1) + '_trial_' + str(k) + '.npy',
...
param_error_all_trials = []
for k in num_trial:
    load = np.load('./results_1/num_waypoints_' + str(2) + '_trial_' + str(k) + '.npy',
                   allow_pickle=True).item()
    parameter_trace = np.array(load['parameter_trace'])[1:]
    true_parameter = np.array(load['true_parameter'])
    parameter_error = np.linalg.norm(parameter_trace - true_parameter, axis=1) ** 2
...
######################################
num_trial = [0, 1, 2, 3, 4, 5, 6, 7, 9]
loss_all_trials = []
param_error_all_trials = []
for k in num_trial:
    load = np.load('./results_1/num_waypoints_' + str(3) + '_trial_' + str(k) + '.npy',
                   allow_pickle=True).item()
    parameter_trace = np.array(load['parameter_trace'])[1:]
    true_parameter = np.array(load['true_parameter'])
    parameter_error = np.linalg.norm(parameter_trace - true_parameter, axis=1) ** 2
...
param_error_all_trials = []
for k in num_trial:
    load = np.load('./results_1/num_waypoints_' + str(4) + '_trial_' + str(k) + '.npy',
                   allow_pickle=True).item()
    parameter_trace = np.array(load['parameter_trace'])[1:]
    true_parameter = np.array(load['true_parameter'])
    parameter_error = np.linalg.norm(parameter_trace - true_parameter, axis=1) ** 2
...
param_error_all_trials = []
for k in num_trial:
    load = np.load('./results_1/num_waypoints_' + str(8) + '_trial_' + str(k) + '.npy',
                   allow_pickle=True).item()
    parameter_trace = np.array(load['parameter_trace'])[1:]
    true_parameter = np.array(load['true_parameter'])
    parameter_error = np.linalg.norm(parameter_trace - true_parameter, axis=1) ** 2
