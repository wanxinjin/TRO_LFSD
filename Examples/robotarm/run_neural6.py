...
time_tau = np.array([0.067, 0.2, 0.267, 0.333, 0.467, 0.6, 0.8, 0.933])
...
for trial in range(0,max_trial):
    ...
    if True:
        save_data = {'loss_trace': loss_trace,
                     ...
                     'lr': lr}
        np.save('./results_data/neural/num_waypoints_' + str(len(time_tau)) + '_trial_' + str(trial) + '.npy',
                save_data)
