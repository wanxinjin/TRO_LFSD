...
time_tau = true_time_grid[[7, ]]
# time_tau = true_time_grid[[7, 12]]
# time_tau = true_time_grid[[ 4, 7, 12]]
# time_tau = true_time_grid[[1, 4, 7, 12]]
...
for trial_num in range(3, max_trial):
    ...
    if True:
        save_data = {'loss_trace': loss_trace,
                     ...
                     'T': T,
                     'lr': lr}
        np.save('./results_data/true/num_waypoints_' + str(time_tau.size) + '_trial_' + str(trial_num) + '.npy', save_data)
